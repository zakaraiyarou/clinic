          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">No. of Patient</h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        ...
                        if ($result = mysqli_query($con, "SELECT id FROM clinic_patient_monitoring ORDER BY id")) {
                          echo "<h6 class='mb-2'>" . mysqli_num_rows($result);
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <?php
                        ...
                        if ($result = mysqli_query($con, "SELECT appointment_id FROM clinic_appointment_table ORDER BY appointment_id")) {
                          echo "<h6 class='mb-2'>" . mysqli_num_rows($result);
